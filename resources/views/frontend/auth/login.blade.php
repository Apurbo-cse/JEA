                        ...
                        <div class="col-md-8">
                            ...
                            <form method="POST" action="{{ route('login') }}">
                                ...
                                <div class="form-group first">
                                    ...
                                    <input id="email" type="text" name="email" :value="old('email')" class="form-control " autofocusid="email">
                                </div>
                                ...
                                <div class="d-flex mb-5 align-items-center">
                                    ...
                                    <span class="ml-auto"><a href="/" class="forgot-pass"><i class="fa fa-home"

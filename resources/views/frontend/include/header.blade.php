	...
	<link href="{{asset('frontend/style/responsive.css')}}" rel="stylesheet">
	...
	<!-- Info -->
	<link rel="stylesheet" href="{{asset('frontend/me/style.css')}}">
	...
	<link href="{{asset('frontend/css/team.css')}}" rel="stylesheet" type="text/css" media="all" />
...
<link rel="stylesheet" href="assets/css/styles.css">
  ...
  <link rel="stylesheet" href="ex-m.css">
    ...
    <!-- Icon -->
    <link rel="stylesheet" href="about/fonts/line-icons.css">
    <!-- Owl carousel -->
